...
public class POST_SearchWithHPR extends SeleniumBaseClass
{
		...
		@Description("Search HPR API") 
		@Story("Search_HPR_API")
		public void Search_HPR_Api() throws EncryptedDocumentException, IOException
		{
			test = extent.createTest("Search_HPR_API");
		...
		@Description("Search HPR API") 
		@Story("Search_HPR_API")
		public void Missing_Search_HPR_Api() throws EncryptedDocumentException, IOException
		{
			test = extent.createTest("Search_HPR_API");
			RestAssured.baseURI = readXpath("eua-hspa","EUA_Base_URI","uhi");
			RequestSpecification httpRequest = RestAssured.given();
