...
public class POST_SearchWithSpecialityFacility extends SeleniumBaseClass
{
		...
		@Description("Search with Speciality and Facility API") 
		@Story("Search_with_Speciality_Facility_API")
		public void Search_Speciality_facility_Api() throws EncryptedDocumentException, IOException
		{
			test = extent.createTest("Search_with_Speciality_Facility_API");
		...
		@Description("Search with Speciality and Facility API") 
		@Story("Search_with_Speciality_Facility_API")
		public void Missing_Search_Speciality_facility_Api() throws EncryptedDocumentException, IOException
		{
			test = extent.createTest("Search_with_Speciality_Facility_API");
			RestAssured.baseURI = readXpath("eua-hspa","EUA_Base_URI","uhi");
			RequestSpecification httpRequest = RestAssured.given();
