...
public class POST_SearchWithSpeciality extends SeleniumBaseClass
{
	  ...
	  SoftAssert softAssert2 = new SoftAssert();
		...
		@Description("Missing Search with Specility API") 
		@Story("Missing_Search_with_Specility_API")
		public void Missing_Search_Specility_Api() throws EncryptedDocumentException, IOException
		{
			test = extent.createTest("Missing_Search_with_Specility_API");
			RestAssured.baseURI = readXpath("eua-hspa","EUA_Base_URI","uhi");
			RequestSpecification httpRequest = RestAssured.given();
