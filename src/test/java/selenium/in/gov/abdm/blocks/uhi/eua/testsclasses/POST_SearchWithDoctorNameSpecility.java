...
public class POST_SearchWithDoctorNameSpecility extends SeleniumBaseClass
{
		...
		public void Search_doctor_speciality_Api() throws EncryptedDocumentException, IOException
		{
		...
		@Severity(SeverityLevel.CRITICAL)
		@Description("Missing Search with Doctor Name API") 
		@Story("Missing_Search_with_Doctor_Name_API")
		public void Missing_Search_doctor_speciality_Api() throws EncryptedDocumentException, IOException
		{
